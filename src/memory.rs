...
pub trait MemoryPool: Send + Sync {
    ...
    fn try_grow(&self, reservation: &mut MemoryReservation, additional_size: usize) -> Result<Vec<u8>, Error>;
    fn shrink(&self, reservation: &mut MemoryReservation, additional_size: usize) -> Result<Vec<u8>, Error>;
